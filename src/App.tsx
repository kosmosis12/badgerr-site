      ...
      <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
        <div className="flex items-center">
          <a href="#" onClick={handleNavClick}>
            <span className="font-heading font-extrabold text-3xl bg-gradient-to-r from-blue-800 via-purple-800 to-cyan-700 bg-clip-text text-transparent">
              Badgerr
            </span>
          </a>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-8">
            <div className="space-y-6">
              <h1 className="font-heading text-6xl lg:text-8xl font-black leading-tight tracking-tight">
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {featuresData.map((feature, index) => (
                        <div key={index} className="group bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-white/50 text-left transform hover:-translate-y-3 hover:shadow-2xl transition-all duration-500 hover:bg-white/90">
                            ...
                            <h3 className="font-heading text-xl font-bold text-gray-800 group-hover:text-indigo-700 transition-colors duration-300">{feature.title}</h3>
    ...
    <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div>
                    <p className="font-heading text-5xl font-extrabold text-indigo-600">9-10h</p>
                    <p className="mt-2 text-gray-600 font-medium">Average Daily Sitting Time</p>
                </div>
                <div>
                    <p className="font-heading text-5xl font-extrabold text-indigo-600">75%</p>
                    <p className="mt-2 text-gray-600 font-medium">Tech Workers Want Better Habits</p>
                </div>
                <div>
                    <p className="font-heading text-5xl font-extrabold text-indigo-600">+27%</p>
        ...
        <div className="container mx-auto px-6 text-center">
            ...
            <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center">
                    ...
                    <h3 className="font-heading text-xl font-bold text-gray-800">Daily Discussions</h3>
                ...
                <div className="text-center">
                    ...
                    <h3 className="font-heading text-xl font-bold text-gray-800">Motivation Boost</h3>
                    <p className="mt-2 text-gray-600">Get encouragement when you need it most.</p>
                </div>
                <div className="text-center">
                    <div className="text-4xl mx-auto mb-4 bg-purple-100 text-purple-600 w-20 h-20 rounded-2xl flex items-center justify-center">🔗</div>
                    <h3 className="font-heading text-xl font-bold text-gray-800">Share Progress</h3>
                    <p className="mt-2 text-gray-600">Celebrate victories together with the community.</p>
                </div>
                <div className="text-center">
                    <div className="text-4xl mx-auto mb-4 bg-purple-100 text-purple-600 w-20 h-20 rounded-2xl flex items-center justify-center">⭐</div>
                    <h3 className="font-heading text-xl font-bold text-gray-800">Expert Tips</h3>
                    ...
                    {testimonialsData.map((testimonial, index) => (
                        <div key={index} className="group bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-white/50 hover:bg-white/90 hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-500">
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    <p className="font-heading font-bold text-gray-800 group-hover:text-indigo-700 transition-colors duration-300">{testimonial.name}</p>
...
const CTA: React.FC = () => (
    <section className="bg-gradient-to-r from-purple-600 to-indigo-700 text-white">
        <div className="container mx-auto px-6 py-20 text-center">
            <h2 className="font-heading text-3xl md:text-4xl font-bold">Ready to Transform Your Wellness Journey?</h2>
        ...
        <footer className="bg-gray-900 text-gray-400">
            <div className="container mx-auto px-6 py-16">
                <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
                    ...
                    <div>
                        <h4 className="font-heading font-semibold text-white mb-4 tracking-wider uppercase text-sm">Product</h4>
                    ...
                    <div>
                        <h4 className="font-heading font-semibold text-white mb-4 tracking-wider uppercase text-sm">Company</h4>
                        <ul className="space-y-2">
                            <li><a href="#about" onClick={(e) => handleNavClick(e, 'about')} className="hover:text-white transition-colors">About</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="font-heading font-semibold text-white mb-4 tracking-wider uppercase text-sm">Support</h4>
                        <ul className="space-y-2">
                            <li><a href="#" className="hover:text-white transition-colors">Contact</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="font-heading font-semibold text-white mb-4 tracking-wider uppercase text-sm">Legal</h4>
                        <ul className="space-y-2">
...
const AboutPage: React.FC = () => (
    <section className="bg-white text-gray-800 py-20 px-4">
        <div className="container mx-auto max-w-4xl">
            <h1 className="font-heading text-4xl font-bold text-center mb-12">About Badgerr</h1>
...
const TermsPage: React.FC = () => (
    <section className="bg-gray-50 text-gray-700 py-20 px-4">
        <div className="container mx-auto max-w-4xl prose lg:prose-lg">
            <h1 className="font-heading">Badgerr Terms & Conditions</h1>
            ...
            <h2 className="font-heading">1. Eligibility and Account Registration</h2>
            ...
            <h2 className="font-heading">2. Description of Service</h2>
            ...
            <h2 className="font-heading">4. Data Collection & Privacy</h2>
            ...
            <h2 className="font-heading">5. Health Disclaimers</h2>
            ...
            <h2 className="font-heading">6. Gamification and Prizes</h2>
            ...
            <h2 className="font-heading">7. User Content and Conduct</h2>
            ...
            <h2 className="font-heading">8. Security and Data Retention</h2>
            ...
            <h2 className="font-heading">9. License and Intellectual Property</h2>
            ...
            <h2 className="font-heading">10. Modifications to Terms and the App</h2>
            ...
            <h2 className="font-heading">11. Termination</h2>
            ...
            <h2 className="font-heading">14. Governing Law and Dispute Resolution</h2>
...
const PrivacyPage: React.FC = () => (
    <section className="bg-gray-50 text-gray-700 py-20 px-4">
        <div className="container mx-auto max-w-4xl prose lg:prose-lg">
            ...
            <h2 className="font-heading">4. How We Protect Your Data</h2>
            <ul>
            ...
            <h2 className="font-heading">5. Your Choices & Rights</h2>
